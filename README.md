...
#### Install Manually 
1. Go to [Releases](#)
2. Find the version you want to download and click the .zip file
3. Launch Minecraft, then go to Options —> Resource Packs —> Open Pack Folder
4. Drop the downloaded .zip file into the newly opened pack folder
5. Click the arrow icon to move the resource pack from ‘Available’ to ‘Selected’

### Minecraft: Bedrock Edition
Coming soon!

## Compatibility
Now Playing is compatible with Minecraft: Java Edition 26.2 and newer.

## Attribution 
You may use this resource pack in modpacks, but you must credit me as Charge.
